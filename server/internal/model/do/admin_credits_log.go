...
// AdminCreditsLog is the golang structure of table c9s_admin_credits_log for DAO operations like Where/Data.
type AdminCreditsLog struct {
	g.Meta      `orm:"table:c9s_admin_credits_log, do:true"`
	Id          interface{} // 变动ID
