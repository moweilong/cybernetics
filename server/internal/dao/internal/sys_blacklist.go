...
// SysBlacklistDao is the data access object for table c9s_sys_blacklist.
...
// SysBlacklistColumns defines and stores column names for table c9s_sys_blacklist.
...
// sysBlacklistColumns holds the columns for table c9s_sys_blacklist.
