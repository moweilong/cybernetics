...
// SysServeLogDao is the data access object for table c9s_sys_serve_log.
...
// SysServeLogColumns defines and stores column names for table c9s_sys_serve_log.
...
// sysServeLogColumns holds the columns for table c9s_sys_serve_log.
