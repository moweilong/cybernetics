...
// SysSmsLogDao is the data access object for table c9s_sys_sms_log.
...
// SysSmsLogColumns defines and stores column names for table c9s_sys_sms_log.
...
// sysSmsLogColumns holds the columns for table c9s_sys_sms_log.
