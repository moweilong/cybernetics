...
// AdminMenuDao is the data access object for table c9s_admin_menu.
...
// AdminMenuColumns defines and stores column names for table c9s_admin_menu.
...
// adminMenuColumns holds the columns for table c9s_admin_menu.
