...
// SysAttachmentDao is the data access object for table c9s_sys_attachment.
...
// SysAttachmentColumns defines and stores column names for table c9s_sys_attachment.
...
// sysAttachmentColumns holds the columns for table c9s_sys_attachment.
