...
// SysLogDao is the data access object for table c9s_sys_log.
...
// SysLogColumns defines and stores column names for table c9s_sys_log.
...
// sysLogColumns holds the columns for table c9s_sys_log.
