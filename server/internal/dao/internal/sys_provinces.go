...
// SysProvincesDao is the data access object for table c9s_sys_provinces.
...
// SysProvincesColumns defines and stores column names for table c9s_sys_provinces.
...
// sysProvincesColumns holds the columns for table c9s_sys_provinces.
