...
// SysLoginLogDao is the data access object for table c9s_sys_login_log.
...
// SysLoginLogColumns defines and stores column names for table c9s_sys_login_log.
...
// sysLoginLogColumns holds the columns for table c9s_sys_login_log.
