...
// SysConfigDao is the data access object for table c9s_sys_config.
...
// SysConfigColumns defines and stores column names for table c9s_sys_config.
...
// sysConfigColumns holds the columns for table c9s_sys_config.
