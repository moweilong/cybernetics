...
// SysEmsLogDao is the data access object for table c9s_sys_ems_log.
...
// SysEmsLogColumns defines and stores column names for table c9s_sys_ems_log.
...
// sysEmsLogColumns holds the columns for table c9s_sys_ems_log.
