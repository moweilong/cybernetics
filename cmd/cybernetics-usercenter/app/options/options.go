...
import (
	...
	"github.com/moweilong/cybernetics/internal/pkg/client"
	"github.com/moweilong/cybernetics/internal/pkg/feature"
...
const (
	// UserAgent is the userAgent name when starting cybernetics-gateway server.
	UserAgent = "cybernetics-usercenter"
)
...
// ApplyTo fills up cybernetics-usercenter config with options.
...
// Config return an cybernetics-usercenter config object.
