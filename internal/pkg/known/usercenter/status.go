...
const (
	...
	// The Cybernetics project does not currently use this.
...
// Define need status.
// We can directly update the database to the "Need" state to inform cybernetics-nightwatch of what needs to be done.
// These statuses are only used for operation and maintenance purposes.
const (
	// UserStatusNeedActive informs cybernetics-nightwatch that the user needs to be activated.
	UserStatusNeedActive = "need_active"
	// UserStatusNeedDisable informs cybernetics-nightwatch that the user needs to be disabled.
