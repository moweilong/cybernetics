...
type UserM struct {
	...
	Status    string    `gorm:"column:status;type:varchar(64);not null;comment:用户状态：registered,active,disabled,blacklisted,locked,deleted" json:"status"` // 用户状态：registered,active,disabled,blacklisted,locked,deleted
