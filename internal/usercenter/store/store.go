...
//go:generate mockgen -self_package github.com/moweilong/cybernetics/internal/usercenter/store -destination mock_store.go -package store github.com/moweilong/cybernetics/internal/usercenter/store IStore,SecretStore,UserStore
