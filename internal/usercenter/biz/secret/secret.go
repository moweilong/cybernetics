...
//go:generate mockgen -self_package github.com/moweilong/cybernetics/internal/usercenter/biz/secret -destination mock_secret.go -package secret github.com/moweilong/cybernetics/internal/usercenter/biz/secret SecretBiz
...
func (b *secretBiz) Create(ctx context.Context, rq *v1.CreateSecretRequest) (*v1.SecretReply, error) {
	...
	secretM.UserID = cyberneticsx.FromUserID(ctx) // Set the user ID from the context.
