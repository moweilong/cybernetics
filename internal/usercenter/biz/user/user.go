...
//go:generate mockgen -self_package github.com/moweilong/cybernetics/internal/usercenter/biz/user -destination mock_user.go -package user github.com/moweilong/cybernetics/internal/usercenter/biz/user UserBiz
...
import (
	...
	validationutil "github.com/moweilong/cybernetics/internal/pkg/util/validation"
	"github.com/moweilong/cybernetics/internal/usercenter/conversion"
...
func (b *userBiz) Update(ctx context.Context, rq *v1.UpdateUserRequest) error {
	...
	if !validationutil.IsAdminUser(cyberneticsx.FromUserID(ctx)) {
		whr = whr.T(ctx)
	}
