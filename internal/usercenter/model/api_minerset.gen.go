...
type MinerSetM struct {
	...
	Replicas             int32     `gorm:"column:replicas;type:int;not null;comment:矿机副本数" json:"replicas"`                                                      // 矿机副本数
	...
	MinReadySeconds      int32     `gorm:"column:min_ready_seconds;type:int;not null;comment:矿机 Ready 最小等待时间" json:"min_ready_seconds"`                          // 矿机 Ready 最小等待时间
	FullyLabeledReplicas int32     `gorm:"column:fully_labeled_replicas;type:int;not null;comment:所有标签匹配的副本数" json:"fully_labeled_replicas"`                     // 所有标签匹配的副本数
	ReadyReplicas        int32     `gorm:"column:ready_replicas;type:int;not null;comment:Ready 副本数" json:"ready_replicas"`                                      // Ready 副本数
	AvailableReplicas    int32     `gorm:"column:available_replicas;type:int;not null;comment:可用副本数" json:"available_replicas"`                                  // 可用副本数
