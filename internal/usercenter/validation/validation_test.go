...
func Test_validator_ValidateListUserRequest(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{
				ctx: cyberneticsx.NewUserID(context.Background(), "user-admin"),
				rq: &v1.ListUserRequest{
					Limit:  0,
					Offset: 10,
				},
		...
		},
		{
			...
			args: args{
				ctx: cyberneticsx.NewUserID(context.Background(), "user-xxx"),
				rq: &v1.ListUserRequest{
					Limit:  0,
					Offset: 10,
				},
...
func Test_validator_ValidateCreateSecretRequest(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{
				ctx: cyberneticsx.NewUserID(context.Background(), "user-test"),
				rq: &v1.CreateSecretRequest{
					Name:        "test",
					Expires:     0,
					Description: "test",
