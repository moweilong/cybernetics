...
//go:generate mockgen -self_package github.com/moweilong/cybernetics/internal/usercenter/auth -destination mock_auth.go -package auth github.com/moweilong/cybernetics/internal/usercenter/auth AuthProvider,AuthzInterface,AuthnInterface
