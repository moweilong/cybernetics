...
// AdminMemberDao is the data access object for table c9s_admin_member.
...
// AdminMemberColumns defines and stores column names for table c9s_admin_member.
...
// adminMemberColumns holds the columns for table c9s_admin_member.
