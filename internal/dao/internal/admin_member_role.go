...
// AdminMemberRoleDao is the data access object for table c9s_admin_member_role.
...
// AdminMemberRoleColumns defines and stores column names for table c9s_admin_member_role.
type AdminMemberRoleColumns struct {
	MemberId string // 管理员ID
	RoleId   string // 角色ID
}

// adminMemberRoleColumns holds the columns for table c9s_admin_member_role.
