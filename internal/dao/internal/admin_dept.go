...
// AdminDeptDao is the data access object for table c9s_admin_dept.
...
// AdminDeptColumns defines and stores column names for table c9s_admin_dept.
...
// adminDeptColumns holds the columns for table c9s_admin_dept.
